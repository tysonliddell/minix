...
PRIVATE void comparecond(struct nodestruct *exp, label_no truelab, label_no falselab, bool_pt nojump)
...
PRIVATE void jumpcond(struct nodestruct *exp, label_no truelab, label_no falselab, bool_pt nojump)
/* bool_pt nojump; */		/* NB if nonzero, is ~0 so complement is 0 */
{
    switch (exp->tag)
    {
...
PRIVATE void logandcond(struct nodestruct *exp, label_no truelab, label_no falselab, bool_pt nojump)
/* bool_pt nojump; */			/* NB if nonzero, is ~0 so complement is 0 */
{
    label_no andlab;
...
PRIVATE void logorcond(struct nodestruct *exp, label_no truelab, label_no falselab, bool_pt nojump)
/* bool_pt nojump; */		/* NB if nonzero, is ~0 so complement is 0 */
{
    label_no orlab;
...
PRIVATE void testcond(struct nodestruct *exp, label_no truelab, label_no falselab, bool_pt nojump)
/* bool_pt nojump; */		/* NB if nonzero, is ~0 so complement is 0 */
{
    ccode_t condtrue;
    struct symstruct *source;

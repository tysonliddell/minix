...
_s_call:			; System calls are vectored here.
	...
	jmp near _restart       ; jump to code to restart proc/task running
...
_tty_int:			; Interrupt routine for terminal input.
	...
	jmp near _restart   ; continue execution
...
save:				; save the machine state in the proc table.
	...
	mov SP_-OFF(bx),sp	; sp as it was prior to interrupt

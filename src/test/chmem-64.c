...
/*
    This is a quick and dirty port of chmem to run on an x86-64 host.
    Replaces `long` with a `LONG` macro and adds a definition for std_err.
    Compiles with gcc -std=gnu89.
*/
...
#define MAX          65536	/* maximum allocation size */
